...
package com.aliyun.jindodata.plugin.oss;

import com.aliyun.jindodata.plugin.oss.aws.AWSMavenCredentialsProviderChain;
import com.aliyun.jindodata.plugin.oss.data.transfer.TransferProgressFileInputStream;
import com.aliyun.jindodata.plugin.oss.data.transfer.TransferProgressFileOutputStream;
import com.aliyun.jindodata.plugin.oss.maven.AbstractWagon;
import com.aliyun.jindodata.plugin.oss.util.IOUtils;
import com.aliyun.jindodata.plugin.oss.util.S3Utils;
 ...
 */
public final class OssWagon extends AbstractWagon {
    ...
    OssWagon(AmazonS3 amazonS3, String bucketName, String baseDirectory) {
        super(true);
...
//            this.amazonS3 = new AmazonS3Client(credentialsProvider);
            this.amazonS3 = AmazonS3Client.builder()
                    ...
                    .withEndpointConfiguration(new AwsClientBuilder.EndpointConfiguration("oss-cn-shanghai.aliyuncs.com", "oss-cn-shanghai"))
                    .build();
